...
session_start();
$sql_ujian = "select * from ujian j inner join kategori k on j.id_kategori=k.id_kategori where id_ujian = '2'";
//$sql_ujian = "select * from settingwaktu where waktu_pengerjaan_gambar=waktu_pengerjaan_gambar";
...
<script src="../../resources/js/bootstrap-stack.js"></script>
