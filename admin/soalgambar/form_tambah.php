  ...
  <body>
      ...
      <div class="container">
          ...
          <a href="index.php?halaman=1" <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button></a>
            ...
            <div class="controls">
                <input type="file" style="width:300px;" name="pilihan_a[]" class="span2 validate[required] text-input">
            </div>
            </div>
            <div class="control-group">
            <label class="control-label" for="nama_hukuman">Jawaban B :</label>
            <div class="controls">
                <input type="file" style="width:300px;" name="pilihan_b[]" class="span2 validate[required] text-input">
            </div>
            </div>
            <div class="control-group">
            <label class="control-label" for="nama_hukuman">Jawaban C :</label>
            <div class="controls">
                <input type="file" style="width:300px;" name="pilihan_c[]" class="span2 validate[required] text-input">
            </div>
            </div>
            <div class="control-group">
            <label class="control-label" for="nama_hukuman">Jawaban D:</label>
            <div class="controls">
                <input  type="file" style="width:300px;" name="pilihan_d[]" class="span2 validate[required] text-input">
            </div>
            </div>
            <div class="control-group">
